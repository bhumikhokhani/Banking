...
public class user_data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setTitle("Loading the data...");
        progressDialog.show();
    ...
    private void enterAmount() {
        ...
        mBuilder.setTitle("Enter the amount").setView(mView).setCancelable(false);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mAmount.getText().toString().isEmpty()){
                    mAmount.setError("Amount can't be left blank!");
                }else if(Double.parseDouble(mAmount.getText().toString()) > newbalance){
                    mAmount.setError("Account doesn't have enough balance!");
                }else{
    ...
    private void transactionCancel() {
        ...
        builder_exitbutton.setTitle("Do you want to cancel this transaction?").setCancelable(false)
